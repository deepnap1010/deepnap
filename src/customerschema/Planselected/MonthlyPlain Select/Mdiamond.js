...
export default function Mdiamond() {
...
<div className="container bg-warning h-200" id="cstname">
   <h3 className='text-center mt-4'>Dear Name You Have Selected Diamond						
   </h3>
</div>
      ...
      <tr>
        ...
        <tr >
            ...
            <tr >
                <td >50 No. of Pages</td>

              
            </tr>

            <tr >
                <td >100 Products/Services Display</td>
            ...
            <tr ><td >5000 Survey SMS MLY (OTD*12)
 </td></tr>
            <tr ><td >2500 IVR Survey-Calls.
 </td></tr>
            <tr ><td >Add to Cart
 </td></tr>
