...
import './payment.css'
import barcode from "../customerschema/barcode.jpg"
    ...
    <div>
      {/* <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card p-3">
                    <div class="card-body border p-0">
                        <p>
                            <a class="btn btn-primary w-100 h-100 d-flex align-items-center justify-content-between payment"
                    ...
                    <div class="card-body border p-0">
                        <p>
                            <a class="btn btn-primary p-2 w-100 h-100 d-flex align-items-center justify-content-between payment"
                                data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="true"
                                aria-controls="collapseExample">
            ...
            <Link to="/rating">  <div class="btn btn-primary payments">
                    Make Payment
                </div></Link>
            </div>
        </div>
...
<div style={{height:"60vh"}} >  <img src={barcode} alt=" " style={{height:"20vh", marginLeft : "45%"}} /></div>
...
<div class="col-12 mt-5">
            <Link to={{pathname:`/rating/${_id}`}}>  <div class="btn btn-primary payments"style={{ marginLeft : "45%"}}  >
                    Make Payment
                </div></Link>
            </div>
